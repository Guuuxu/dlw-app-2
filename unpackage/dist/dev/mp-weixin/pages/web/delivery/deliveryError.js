...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.onLoad((option) => {
      common_vendor.index.__f__("log", "at pages/web/delivery/deliveryError.vue:53", JSON.parse(option.item));
      let data = option;
      row.value = option.item ? JSON.parse(option.item) : {}, common_vendor.index.__f__("log", "at pages/web/delivery/deliveryError.vue:56", "row.value", row.value);
      msg.value = data.msg;
    });
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/web/delivery/deliveryError.js.map
