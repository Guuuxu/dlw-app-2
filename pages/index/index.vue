    ...
    <view class="content">
      ...
      >
        ...
        <view class="flex-1 ml-48">
          <view class="fs-36"> 初始认证 </view>
          <view class="fs-28 color-subTitlle mt-8"
            >新包装编码、外观等验收入库</view
          >
        </view>
        <image
      ...
      <view
        class="content-item d-f bg_white ai-c pl-48 pr-32 mb-32"
        @click="pageTo('/pages/delivery/index')"
      >
        <image
          class="home-icon"
